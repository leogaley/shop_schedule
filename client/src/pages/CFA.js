...
class CFA extends Component {
    ...
    constructor(props){
        super(props);
        this.state = {
            reportId: "1315", // edit this to change which report populates the table
            statusField: "custbody171", // edit this to change which status gets updated
            scheduleName: "CF Assembly", // edit this to change department name for heading
            woStatusValue: "Assembly (CF)", // edit this to change the filter that determines if a checkbox shows up
            selectedIds: [],
            selectedWos: [],
            woDetail: [],
            modal: false,
...
// Method to update WO status
    updateWo() {
      console.log('update wo function');
      document.body.style.cursor = 'wait';
      const woArray =[];
