...
class StockA extends Component {
    ...
    constructor(props){
        super(props);
        this.state = {
            reportId: "1314", // edit this to change which report populates the table
            statusField: "custbody170", // edit this to change which status gets updated
            scheduleName: "Stock Assembly", // edit this to change department name for heading
            woStatusValue: "Assembly (Stock)", // edit this to change the filter that determines if a checkbox shows up
            selectedIds: [],
            selectedWos: [],
            woDetail: [],
            modal: false,
