...
$service = new NetSuiteService();
  ...
  $search->recType->internalId = '173';
  $searchid[1] = "1207";
  
  if($id==null){
    $search->savedSearchId = "1598";//Shop Schedule - Web Services
  }
  else if($id=='1'){
...
$searchResponse = $service->search($request);
      ...
      print_r($request);//variable dump for testing
      print '</pre>';
      ...
      <th> SO # : Customer</th>
          ...
          foreach ($records as $record)  {
           ...
           $woString = "WO: ".$woNum." Item: ".$woItem." ".$woItemName;
            ...
            $checkmark = "<td><img src='checkmark.png' alt='' style='float:center;width:15px;height:15px;'></td>\n";//add icon for whether *SH items are in stock
